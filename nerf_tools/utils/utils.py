...
def load_pcd(dataset_path, pcd_config: SamplePCD) -> o3d.geometry.PointCloud:
    ...
    pcd = get_pointcloud(dataset, pcd_config.max_depth, pcd_config.skip_frames, 
